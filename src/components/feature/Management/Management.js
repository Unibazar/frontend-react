    ...
    <>
      <div className="w-full mt-10">
        <div className="bg-[#F5FDFD] text-center py-6 max-md:px-3">
          <span className="text-[28px] leading-8 my-2 max-md:text-[25px]">Unlock the Power of Seamless E-commerce Management </span>
          <p className="text-[#455a64] text-[14px] max-md:text-[12px] mt-3">
        ...
        <div className="flex items-center justify-evenly md:gap-32 max-md:flex-col-reverse my-5 max-md:px-5">
          ...
          <div className="flex flex-col max-md:my-10 max-md:w-full">
            ...
            <h2 className="text-[28px] leading-8 my-2 max-md:text-[25px]">Connect All Your Platforms Effortlessly</h2>
            <p className="text-[#455a64] text-[16px] max-md:text-[14px]">
        ...
        <div className="flex items-center justify-evenly md:gap-32 max-md:flex-col my-14 max-md:px-5">
          <div className="flex flex-col  max-md:my-10 max-md:w-full">
            ...
            <h2 className="text-[28px] leading-8 my-2 max-md:text-[25px]">Centralized Management Hub</h2>
            <p className="text-[#455a64] text-[16px] max-md:text-[14px]">
        ...
        <div className="flex items-center justify-evenly md:gap-32 max-md:flex-col-reverse my-14 max-md:px-5">
          ...
          <div className="flex flex-col  max-md:my-10 max-md:w-full">
            ...
            <h2 className="text-[28px] leading-8 my-2 max-md:text-[25px]">Actionable Insights at Your Fingertips </h2>
            <p className="text-[#455a64] text-[16px] max-md:text-[14px]">
        ...
        <div className="flex items-center justify-evenly md:gap-32 max-md:flex-col my-14 max-md:px-5">
          <div className="flex flex-col max-md:my-10 max-md:w-full">
            ...
            <h2 className="text-[28px] leading-8 my-2 max-md:text-[25px]">Keep Your Stock in Sync </h2>
            <p className="text-[#455a64] text-[16px] max-md:text-[14px]">
        ...
        <div className="flex items-center justify-evenly md:gap-32 max-md:flex-col-reverse my-14 max-md:px-5">
          ...
          <div className="flex flex-col max-md:my-10 max-md:w-full">
            ...
            <h2 className="text-[28px] leading-8 my-2 max-md:text-[25px]">List Once, Sell Everywhere</h2>
            <p className="text-[#455a64] text-[16px] max-md:text-[14px]">
        ...
        <div className="flex items-center justify-evenly md:gap-32 max-md:flex-col my-14 max-md:px-5">
          <div className="flex flex-col max-md:my-10 max-md:w-full">
            ...
            <h2 className="text-[28px] leading-8 my-2 max-md:text-[25px]">Designed for Ease of Use</h2>
            <p className="text-[#455a64] text-[16px] max-md:text-[14px]">
