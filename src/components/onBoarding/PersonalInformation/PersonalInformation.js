...
const PersonalInformation = ({ nxt }) => {
  return (
    <div className="w-[600px] bg-gray-50 max-w-full max-md:mt-10 h-fit gap-0  flex flex-col items-center my-10 py-10 rounded-xl">
      ...
      <form className="flex flex-col mt-10 w-[440px]">
        ...
        <button className="bg-teal-600 hover:bg-teal-800 max-sm:w-full px-24 py-4 text-[22px] font-normal text-white tracking-[0.05rem] rounded-lg mt-5" onClick={nxt}>
          NEXT
        </button>
      </form>
    </div>
