...
const PersonalInformation = ({ nxt }) => {
  return (
    <div className="w-[480px] max-w-full max-md:my-10 h-fit gap-0 rounded-tl-[16px] flex flex-col my-32">
      ...
      <form className="flex flex-col mt-10">
        ...
        <button className="self-center bg-custom-gradient max-sm:w-full w-[60%] py-6 text-[22px] font-normal leading-[22px] text-white tracking-[0.05rem] rounded-lg mt-7" onClick={nxt}>
          NEXT
        </button>
      </form>
    </div>
