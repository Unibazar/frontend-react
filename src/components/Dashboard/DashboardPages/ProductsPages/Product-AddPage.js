                ...
                <form onSubmit={handleSubmit(onSubmit)} className="w-full">
                  ...
                  <div className="submitBtn mt-4 flex justify-between items-center gap-5">
                    ...
                    <div className="flex gap-5 items-center">
                      <button type="button" className="p-2 px-4 bg-[#518f8c] text-white rounded-lg flex gap-2 items-center">Save as Draft</button>
                      <button type="submit" className="p-2 px-4 bg-[#08A9A0] text-white rounded-lg flex gap-2 items-center">Save <span className="text-2xl"><IoIosArrowRoundForward /></span></button>
                    </div>
                  </div>
                </form>
              </TabPanel>
