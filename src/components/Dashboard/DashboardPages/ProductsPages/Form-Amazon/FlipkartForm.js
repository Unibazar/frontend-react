...
import { TextField, Accordion, AccordionSummary, AccordionDetails, FormControlLabel, Checkbox, InputLabel, Select, MenuItem, FormLabel, RadioGroup, Radio } from "@mui/material";
...
function FlipkartForm({handleSubmit,onSubmit,control,ProductPhotoSrc1, productPhoto1 ,ProductPhotoSrc2 ,productPhoto2, ProductPhotoSrc3 , productPhoto3 ,ProductPhotoSrc4,productPhoto4 , errors}) {
  return (
                  ...
                  <div>
                    <Accordion>
                      ...
                      <AccordionDetails className="flex flex-col gap-4">
                        ...
                        <FormControlLabel control={<Checkbox name="hasProductID"  />} label="This Product Does Not Have Product ID" className="w-fit" />
                      </AccordionDetails>
                    </Accordion>
