  ...
  return (
    <div className="h-full w-full  px-4 py-4 md:px-7 md:py-7">
      <div className="title flex flex-wrap justify-between items-center">
        <h1 className="md:text-3xl text-lg font-semibold ">Help & Support - ContactSupport</h1>
      </div>
      <div className="boxs mt-4 bg-white rounded-lg p-4 md:p-7">
        ...
        <form className="p-4 mt-5 space-y-10" onSubmit={handleSubmit}>
          ...
          <div className="mt-5">
            ...
            <button type='submit' className="p-2 px-4 bg-[#08A9A0] text-white rounded-lg flex gap-2 items-center hover:bg-[#468582]">Send Message </button>
