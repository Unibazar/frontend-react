        ...
        <div className={styles.pricingPart} >
            <div className={styles.temp}>
                ...
                <p className={`${styles.verySmall} ${styles.small}`}>
                    ...
                    Real-time Analytics  <b>- No </b><br/>
                    Inventory Management  <b>- No</b> <br/>
                    Customer Support Level  <b> basic</b> <br/>

                </p>
                <div className={`${styles.btn} ${styles.navButtons}`}>
                    <a href="#" className="px-4 py-2 text-white bg-teal-700 rounded hover:bg-teal-800 ">Get started</a>
                </div>
            </div>
            <div className={styles.temp}>
                <p>PRO</p>
                ...
                <p className={`${styles.verySmall} ${styles.small}`}>
                    ...
                    Customer Support Level-  <b>Priority</b><br/>


                </p>
                <div className={`${styles.btn} ${styles.navButtons}`}>
                    <a href="#" className='px-4 py-2 text-white bg-teal-700 rounded hover:bg-teal-800 '>Subscription</a>
                </div>
            </div>
            <div className={styles.temp}>
                <p>ENTERPRISE</p>
                ...
                <div className={`${styles.btn} ${styles.navButtons}`}>
                    <a href="#" className="px-4 py-2 text-white bg-teal-700 rounded hover:bg-teal-800 ">Contact Us</a>
                </div>
            </div>
        </div>
    </div>
