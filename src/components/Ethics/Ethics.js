...
// import '../../styles/components/Ethics.css';
const Ethics = () => {
  return (
    <>
      {/*our mission */}
      <div className="w-full flex md:flex-row flex-col justify-around p-5">
        ...
        <div className="w-full md:w-1/2 p-5">
          ...
          <p className="text-lg text-gray-600 p-5">At Unibazar, we aim to simplify and revolutionize the way sellers manage their e-commerce platforms. By providing a unified, user-friendly interface, we empower businesses to seamlessly handle multiple online marketplaces, enhancing efficiency and boosting sales.</p>
        </div>
      </div>
      {/*our values */}
      <div className="w-full flex md:flex-row flex-col justify-around p-5">
