      ...
      <div className="w-full flex-col justify-center items-center text-center md:p-10">
        ...
        <div className="flex md:flex-row  w-full flex-col gap-5 items-center  justify-center   justify-items-center py-10">
          <div className="w-full rounded-xl border border-gray-200 p-1.5 md:w-80">
            ...
            <p className="text-base text-gray-500">List your products across various platforms with a single click.</p>
          </div>
          <div className="w-full rounded-xl border border-gray-200 p-1.5 md:w-80">
            <p className="text-2xl font-bold p-3">
              CENTRALIZE
            ...
            <p className="text-base text-gray-500">Monitor sales, inventory, and orders from one comprehensive dashboard.</p>
          </div>
          <div className="w-full rounded-xl border border-gray-200 p-1.5 md:w-80">
            <p className="text-2xl font-bold p-3">
              GAIN
            ...
            <p className="text-base text-gray-500">Leverage real-time analytics to make informed business decisions</p>
          </div>
        </div>
      </div>
    </>
