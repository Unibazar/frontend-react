    ...
    <div className='bg-gray-50 h-1/2 w-full flex md:flex-row flex-col justify-around items-start p-5'>
      <div className='p-5 max-w-md'>
        <ul>
         ...
         <p className='text-gray-600 font-light text-1xl pb-4 pt-4 '>
      ...
      <div className=' flex md:flex-row justify-between '>
        <div className='p-5'>
          <ul>
            <p className='text-gray-800 font-normal text-1xl pb-4'>
              COMPANY
            </p>
      ...
      <div className='p-5'>
        <ul>
          ...
          <li className='text-gray-600 text-md pb-2 font-light hover:text-blue-500 cursor-pointer'>Email: <a href=''>support@unibazar.com</a></li>
